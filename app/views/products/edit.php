...
<head>
    ...
    <title><?= htmlspecialchars($page_title ?? 'Edit Product – Kyle Daniel Belano') ?></title>
...
<div class="page-content">
    <div class="tag">DATABASE // MYDB.PRODUCTS // EDIT</div>

    <div class="page-header">
        <h1>UPDATE <em>PRODUCT</em></h1>
        <p>Modify the product specifications for database record #<?= htmlspecialchars($product['id']); ?>.</p>
    </div>

    <div class="form-card">
        <div class="form-toolbar">
            <span class="toolbar-title">Edit Product</span>
            <span class="toolbar-meta">ID #<?= htmlspecialchars($product['id']); ?></span>
        </div>
